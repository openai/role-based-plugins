---
name: url-to-code
description: "Clone a live URL as a runnable frontend-only local app using Browser/Chrome source evidence."
---
...
12. Run [design-qa](../design-qa/SKILL.md).
   - Save the QA report as `design-qa.md`.
...
- Use Playwright if Browser and Chrome fail, but mark verification partial unless the user accepts it.
