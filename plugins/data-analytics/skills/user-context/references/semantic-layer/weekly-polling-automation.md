...
Use the Codex app automation tool, not raw automation directives. If the automation tool is not already available, use `tool_search` to find `automation_update`.
